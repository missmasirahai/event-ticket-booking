...
└── script.js       # Interactivity: button clicks, toggles, form validation
```
...
3. **UI Components** — reusable card patterns, icons, buttons
4. **Front-End Interaction** — DOM manipulation, event handling, form validation
5. **Responsive Design** — media queries, mobile-first testing, cross-device usability
